...
const IncomeCategoryManagement = () => {
  ...
  const iconOptions = [
    'Tag', 'Sparkles', 'Heart', 'Camera', 'GraduationCap', 'MessageCircle',
    'MoreHorizontal', 'Star', 'Award', 'Gift', 'Briefcase', 
    'Users', 'Smile', 'TrendingUp', 'DollarSign'
  ];
  ...
  return (
    <div className="bg-card border border-border rounded-2xl p-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="font-bold text-lg text-foreground">Kategori Pemasukan</h3>
      </div>
      <p className="text-sm text-muted-foreground mb-4">
        Kelola kategori untuk pemasukan bisnis Anda
      </p>
